...
description: Implement modern responsive layouts using container queries, fluid typography, CSS Grid, and mobile-first breakpoint strategies. Use when building adaptive interfaces, implementing fluid layouts, or creating component-level responsive behavior. Triggers on "responsive design", "mobile layout", "adaptable UI", "diseño responsivo", "que se vea bien en móvil", "container queries", "fluid typography", or any task requiring multi-device layout support.
---
